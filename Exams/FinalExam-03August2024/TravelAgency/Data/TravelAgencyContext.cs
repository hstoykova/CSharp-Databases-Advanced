...
namespace TravelAgency.Data
{
    ...
    {
        private const string connectionString = @"Server=HRISI\SQLEXPRESS;Database=TravelAgency;Integrated Security=True;";
        ...
        {
            modelBuilder.Entity<TourPackageGuide>().HasKey(tp => new { tp.TourPackageId, tp.GuideId });
